...
//        Role roleModerator = Role.builder().name("ROLE_Moderator").build();
...
////---------------------------------------------------------------Countries
//        Country russia = Country.builder().name("Russia").cities(List.of(moscow, petersburg)).build();
//        Country ukraine = Country.builder().name("Ukraine").cities(List.of(kyiv, kharkiv)).build();
//        Country belorus = Country.builder().name("Belorus").cities(List.of(minsk, gomel)).build();
//
...
//                .cityIndex("minsk_index")
//                .country(countryRepository.findByName("Belorus"))
//                .city(cityRepository.findByName("minsk"))
//                .street("user3_street")
//                .house("user3_house")
//                .build();
////---------------------------------------------------------------Images
//        File admin_image =  ResourceUtils.getFile("classpath:static/images/admin_image.jpg");
//        File moderator_image =  ResourceUtils.getFile("classpath:static/images/moderator_image.jpg");
...
//        File user3_image =  ResourceUtils.getFile("classpath:static/images/user3_image.jpg");
//
...
//
//        Image adminImage = Image.builder().url("adminImageUrl").picture(array_admin_image).isMain(true).build();
//        Image moderatorImage = Image.builder().url("moderatorImageUrl").picture(array_moderator_image).isMain(true).build();
//        Image user1Image = Image.builder().url("user1ImageUrl").picture(array_user1_image).isMain(true).build();
//        Image user2Image = Image.builder().url("user2ImageUrl").picture(array_user2_image).isMain(true).build();
//        Image user3Image = Image.builder().url("user3ImageUrl").picture(array_user3_image).isMain(true).build();
//
//        Image shop1Image = Image.builder().url("shop1ImageUrl").picture(array_shop1_image).isMain(true).build();
//        Image shop2Image = Image.builder().url("shop2ImageUrl").picture(array_shop2_image).isMain(true).build();
//
//        Image item1Image1 = Image.builder().url("item1Image1Url").picture(array_item1_image1).isMain(true).build();
//        Image item1Image2 = Image.builder().url("item1Image2Url").picture(array_item1_image2).isMain(false).build();
//        Image item1Image3 = Image.builder().url("item1Image3Url").picture(array_item1_image3).isMain(false).build();
//
//        Image item2Image1 = Image.builder().url("item2Image1Url").picture(array_item2_image1).isMain(true).build();
//        Image item2Image2 = Image.builder().url("item2Image2Url").picture(array_item2_image2).isMain(false).build();
//        Image item2Image3 = Image.builder().url("item2Image3Url").picture(array_item2_image3).isMain(false).build();
//
//        Image item3Image1 = Image.builder().url("item3Image1Url").picture(array_item3_image1).isMain(true).build();
//        Image item3Image2 = Image.builder().url("item3Image2Url").picture(array_item3_image2).isMain(false).build();
//        Image item3Image3 = Image.builder().url("item3Image3Url").picture(array_item3_image3).isMain(false).build();
////---------------------------------------------------------------Admin + Moderator
...
//                .address(null)
//                .age(0)
//                .roles(Set.of(roleRepository.findByName("ROLE_Moderator")))
//                .gender(Gender.UNKNOWN)
//                .birthday(null)
